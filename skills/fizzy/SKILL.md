...
**Important:** Before using any fizzy commands, run the load metadata script to cache board, column, tag, and user information:

```bash
~/.claude/skills/fizzy/scripts/load-fizzy-metadata
```

This ensures you have the IDs needed to work with boards, columns, and users.
